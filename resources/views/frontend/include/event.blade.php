         ...
         <div class="row">
             <div class="event-items">
                 ...
                 <div class="item horizontal col-md-12">
                     <div class="col-md-6 thumb bg-cover" style="background-image: url({{ asset('/') }}frontend/assets/img/event/1.jpg);">
                         <div class="date">
                     ...
                     <div class="col-md-6 info">
                         ...
                         <p>
                             Early had add equal china quiet visit. Appear an manner as no limits either praise in. In
                             in written on charmed justice is amiable farther besides. Law insensible middletons
                 ...
                 <!-- Single Item -->
                 <div class="item horizontal col-md-12">
                     <div class="col-md-6 thumb bg-cover" style="background-image: url({{ asset('/') }}frontend/assets/img/event/4.jpg);">
                         <div class="date">
